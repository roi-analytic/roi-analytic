            ...
            <div className="rounded-[22px] bg-card p-8 md:p-12">
              ...
              <div className="relative mb-10">
                ...
                <blockquote className="text-xl md:text-2xl text-foreground font-medium leading-relaxed pl-8">
                  "Antes dependíamos casi solo del boca a boca. Desde que
                  trabajamos con{" "}
                  <span className="text-primary font-bold">ROI Analytic</span>{" "}
                  empezamos a recibir solicitudes de clientes de forma constante
                  todos los meses, y además son contactos que realmente quieren
                  contratar. Para nosotros ha sido un cambio enorme."
                </blockquote>
              </div>
